...
workbook = Workbook()
workbook.save(filename="Word-count-native-english.xlsx")
...
workbook.save(filename="Word-count-native-english.xlsx")
wb.save("Word-count-native-english.xlsx")


####WORD COUNT EXCEL FILE FOR TRANSLATED DOCUMENTS####
workbook.save(filename="Word-count-translated.xlsx")
...
for i in range(0,len2):
    ...
    c5.value = count
workbook.save(filename="Word-count-translated.xlsx")
wb.save("Word-count-translated.xlsx")
